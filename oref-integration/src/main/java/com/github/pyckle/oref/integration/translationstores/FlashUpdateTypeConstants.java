...
public class FlashUpdateTypeConstants
{
    // hardcoded strings that indicate the severity of an alert.
    public static final String GREEN_NRC_LEAVE_BUILDING = "אירוע בקריה למחקר גרעיני בנגב  – ניתן לצאת ממבנים";
    ...
    public static final String GREEN_TERRORIST_THREAT_ENDED_2 = "הוסר החשש לחדירת מחבלים";
    public static final String GREEN_TERRORIST_THREAT_ENDED_3 = "הסתיים אירוע חדירת מחבלים - ניתן לצאת מהבתים";
    ...
    public static final String GREEN_EVENT_ENDED = "האירוע הסתיים";
    ...
    public static final String YELLOW_STAY_CLOSE_TO_SHELTER3 = "התקרבו למרחב מוגן";
    ...
    public static final String ORANGE_THREAT_FROM_LEBANON = "איום מלבנון - התקרבו למרחב מוגן";
